...
namespace Facebook
{
    public sealed class CanvasFacebook : AbstractFacebook
    {
        ...
        internal const string SDKVersion = "v2.2";
                ...
                HideUnityDelegate hideUnityDelegate = null)
        {
            ...
            parameters.Add("version", SDKVersion);
            ...
            FacebookDelegate callback) 
        {
            ...
            {
                paramsDict["link"] = contentURL;
            }
            
            if (!string.IsNullOrEmpty(contentTitle))
            {
                paramsDict["name"] = contentTitle;
            }

            if (!string.IsNullOrEmpty(contentDescription))
            {
                paramsDict["description"] = contentDescription;
            }
            
            if (!string.IsNullOrEmpty(photoURL))
            {
                paramsDict["picture"] = photoURL;
            }
